...
// document.querySelector("h1").id = "titre"; // alternative au code du dessus
...
// ================== EXERCICE =================================================
// =============================================================================
document.getElementById('contenu').insertAdjacentHTML("afterEnd", '<p>En voici une <a id="languages_list" href="https://fr.wikipedia.org/wiki/Liste_des_langages_de_programmation">liste</a> plus complète.</p>');
